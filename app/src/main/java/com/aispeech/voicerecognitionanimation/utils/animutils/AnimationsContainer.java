package com.aispeech.voicerecognitionanimation.utils.animutils;
...
import com.aispeech.voicerecognitionanimation.ui.MyApplication;
...
public class AnimationsContainer {
    ...
    public static AnimationsContainer getInstance(int resId, int fps) {
        ...
        mInstance.setResId(resId);
        mInstance.setFPS(fps);
        mInstance.setmProgressAnimFrames(mInstance.getData(resId));
        return mInstance;
    }
    ...
    public void setmProgressAnimFrames(int[] mProgressAnimFrames) {
        this.mProgressAnimFrames = mProgressAnimFrames;
    }
